...
export default function UglyTakePage({
  id,
}: {
  id: string;
}): React.ReactElement {
      ...
      >
        ...
        {state === 'missing' && (
          ...
          >
            ...
            <a
              ...
              data-id="back-to-the-satire"
            >
              Back to the Satire Desk →
            </a>
          </p>
        )}
        ...
        {state === 'ready' && cluster && take && (
          <article style={{ marginTop: 18 }}>
            <span style={{ ...satireStamp, fontSize: 15, marginBottom: 16 }}>
            ...
            <div
              className="uc-body"
              dangerouslySetInnerHTML={{
                __html: renderMarkdown(take.markdown),
              }}
            />
            ...
            >
              ...
              <a
                ...
                onClick={navClick(() => {
                  router.push('story/:id', { id: cluster.id });
                })}
                data-id="ugly-take-see-coverage"
                style={{
                  ...btn(C),
