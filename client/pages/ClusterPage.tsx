  ...
  return (
    <div style={pageStyle}>
      ...
      >
        ...
        {state === 'loading' && (
          <p style={{ ...mono, color: C.muted, marginTop: 40 }}>
            Pulling every angle…
          </p>
        )}
        {state === 'missing' && (
          ...
          >
            This story has gone to press elsewhere.{' '}
            <a
              href="/"
              onClick={navClick(() => {
                router.push('', {});
          ...
          <>
            ...
            >
              ...
              <span style={{ color: C.muted }}>
                {' '}
                · {cluster.sourceCount} SOURCES · {cluster.articleCount}{' '}
                ARTICLES
              </span>
            </div>
            <h1
            ...
            {cluster.uglyTake && (
              ...
              >
                ...
                >
                  This one got the Ugly treatment — read the satire ↓
                </span>
              </a>
            )}
            ...
            >
              ...
              >
                <span>
                  Factuality: {factualityLabel(cluster.factualityAvg)}
                </span>
            ...
            isSubstantiveSummary(cluster.framingSummary) ? (
              ...
              >
                ...
                >
                  ...
                  {isSubstantiveSummary(cluster.neutralSummary) ? (
                    <div
                      className="uc-body"
                      dangerouslySetInnerHTML={{
                        __html: renderMarkdown(cluster.neutralSummary!),
                      }}
                    />
                  ) : (
                    <p style={{ ...mono, color: C.muted }}>
                      The wire desk is still writing the neutral account.
                    </p>
                  )}
                </div>
                <div style={{ padding: '22px 24px' }}>
                  ...
                  {isSubstantiveSummary(cluster.framingSummary) ? (
                    <div
                      className="uc-body uc-frame"
                      dangerouslySetInnerHTML={{
                        __html: renderMarkdown(cluster.framingSummary!),
                      }}
                    />
                  ) : (
                    <p style={{ ...mono, color: C.muted }}>
                      Needs coverage from more than one side.
                    </p>
                  )}
                </div>
              </section>
            ...
            {cluster.uglyTake && (
              ...
              >
                <span
                  style={{ ...satireStamp, fontSize: 15, marginBottom: 12 }}
                >
                  ⌖ Satire — Not A Real Story
                </span>
                {cluster.uglyTake.imageUri && (
                  <img
                    src={cluster.uglyTake.imageUri}
                    alt=""
                    style={{
                      width: '100%',
                      maxHeight: 260,
                ...
                <div
                  className="uc-body"
                  dangerouslySetInnerHTML={{
                    __html: renderMarkdown(cluster.uglyTake.markdown),
                  }}
                />
              </section>
            )}
