      ...
      >
        ...
        {state === 'ready' && article && (
          <article style={{ marginTop: 18 }}>
            ...
            >
              {dateStr}
              {article.feedId ? ` · via ${article.feedId}` : ''}
            </div>
            {article.clusterId && (
              <a
                href={`/story/${article.clusterId}`}
                onClick={navClick(() => {
                  router.push('story/:id', { id: article.clusterId! });
                })}
            ...
            <div
              className="ar-body"
              dangerouslySetInnerHTML={{
                __html: renderMarkdown(article.markdown),
              }}
            />
            {article.sourceUri && (
              <p
              ...
              >
                <a
                  ...
                  style={{ color: C.accent }}
                  data-id="read-the-original-source"
                >
